...
class Categoria(models.Model):
    id_categoria = models.CharField(max_length=30, primary_key=True)
    nombre = models.CharField(max_length=50)

    def __str__(self):
        return "{0} - {1}".format(self.id_categoria, self.nombre)
...
class Pelicula(models.Model):
    ...
    imdb_url = models.CharField(max_length=100, null=True) 
...
class Puntuacion(models.Model):
    ...
    def __str__(self):
        return "Puntuación: {1}/5 | Película: {0}".format(self.pelicula, self.valoracion)